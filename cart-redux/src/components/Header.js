      ...
      <header>
        ...
        >
          ...
          <li>
            <ul className="social">
              <li>
                <a href="index.html" className="icons-sm fb-ic">
                  <i className="fa fa-facebook"> </i>
                </a>
              </li>
              <li>
                <a href="index.html" className="icons-sm pin-ic">
                  <i className="fa fa-pinterest"> </i>
                </a>
              </li>
              <li>
                <a href="index.html" className="icons-sm gplus-ic">
                  <i className="fa fa-google-plus"> </i>
                </a>
              </li>
              <li>
                <a href="index.html" className="icons-sm tw-ic">
          ...
          <li>
            <ul className="collapsible collapsible-accordion">
              <li>
                <a href="index.html" className="collapsible-header waves-effect arrow-r">
              ...
              <li className="active">
                <a href="index.html" className="collapsible-header waves-effect arrow-r active">
        ...
        <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
          <div className="float-left">
            <a href="index.html" data-activates="slide-out" className="button-collapse">
          ...
          <ul className="nav navbar-nav nav-flex-icons ml-auto">
            <li className="nav-item dropdown">
              ...
              >
                <a href="index.html" className="dropdown-item waves-effect waves-light">
                  Đăng Ký
                </a>
                <a href="index.html" className="dropdown-item waves-effect waves-light">
                  Đăng Nhập
